...
struct Person {
    ...
    init(name: String, lastName: String = "", jobTitle: String? = nil, image: UIImage? = nil, periode: Periode = .notIntroduced, lastContact: Date? = nil, nextContact: Date? = nil, mobileNumber: String? = "", email: String? = "", personalNotes: String? = nil) {
        self.name = name
